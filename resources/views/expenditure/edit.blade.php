...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Edit {{ ucfirst("pengeluaran") }}</li>
        </ol>
    </nav>
        ...
        <div class="card-body">
            <form action="{{ route("expenditure.update", $expenditure->id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="description" name="description" placeholder="Enter description..." value="{{ $expenditure->description }}" required>
                </div>
                <div class="form-group">
                    <label for="value">{{ ucfirst('value') }}</label>
                    <input type="number" class="form-control" id="value" name="value" placeholder="Enter value..." value="{{ $expenditure->value }}" required>
                </div>
                <div class="form-group">
