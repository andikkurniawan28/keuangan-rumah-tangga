...
<head>
    ...
    <meta name="description" content="Admin Apps">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <ul class="navbar-nav bg-gradient-{{ $global["app_color"] }} sidebar sidebar-{{ $global["app_font_color"] }} accordion" id="accordionSidebar">
                    ...
                    {{-- <form
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <button class="btn btn-{{ $global["app_color"] }}" type="button">
